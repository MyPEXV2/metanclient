...
public class Generator {
    public String generateName() {
        ...
        int baseRandom = (int) MathUtil.random(0, 7);
        switch (baseRandom) {
            case 0:
            ...
            case 6:
                if (!prefix.equals("DATE_OF_BIRTH")) {
                    base = (int) MathUtil.random(0, 9) + base;
                }
                if (prefix.equals("DATE_OF_BIRTH") && !suffix.equals("DATE_OF_BIRTH")) {
                    base = base + (int) MathUtil.random(0, 9);
                }
                break;
        }
        ...
        if (!suffix.equals("DATE_OF_BIRTH")) {
            prefix = prefix.replaceFirst("DATE_OF_BIRTH", (int) MathUtil.random(0, 9999) + "");
        }
        if (!prefix.equals("DATE_OF_BIRTH")) {
            suffix = suffix.replaceFirst("DATE_OF_BIRTH", (int) MathUtil.random(0, 9999) + "");
        }
        int random = (int) MathUtil.random(0, 2);
        switch (random) {
            case 0:
                prefix = prefix.replaceFirst("RANDOM", randomString((int) MathUtil.random(1, 3)) + "_");
                break;
            case 1:
                prefix = prefix.replaceFirst("RANDOM", randomString((int) MathUtil.random(1, 2)) + "__");
                break;
            case 2:
                prefix = prefix.replaceFirst("RANDOM", randomString(1) + "___");
                break;
        }
        random = (int) MathUtil.random(0, 2);
        switch (random) {
            case 0:
                suffix = suffix.replaceFirst("RANDOM", "_" + randomString((int) MathUtil.random(1, 3)));
                break;
            case 1:
                suffix = suffix.replaceFirst("RANDOM", "__" + randomString((int) MathUtil.random(1, 2)));
                break;
            case 2:
        ...
        int suffixRandom = (int) MathUtil.random(0, 6);
        switch (suffixRandom) {
            case 0:
        ...
        int prefixRandom = (int) MathUtil.random(0, 6);
        switch (prefixRandom) {
            case 0:
        ...
        if (name.length() <= 13) {
            int randomAddNumbers = (int) MathUtil.random(0, 1);
            if (randomAddNumbers == 0) {
                name = name + "_" + randomString((int) MathUtil.random(0, 3));
            } else {
                name = randomString((int) MathUtil.random(0, 3)) + "_" + name;
            }
        }
        if (name.length() >= 16) {
            name = name.substring(0, (int) MathUtil.random(12, 16));
        }
        return name;
    }

    private String randomString(int w) {
    ...
    private String getRandomPartOfName(String[] array) {
