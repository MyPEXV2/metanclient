...
public class KawaseBloomUp implements IShader {
    @Override
    public String shader() {
        return """
                ...
                void main() {
                    ...
                    gl_FragColor = vec4(color.rgb / color.a, mix(result.a, result.a * (1.0 - texture2D(textureToCheck, gl_TexCoord[0].st).a),check));
                }""";
    }
}
