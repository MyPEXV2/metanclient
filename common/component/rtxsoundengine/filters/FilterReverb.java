...
public class FilterReverb extends BaseFilter {
    ...
    public void loadParameters() {
        ...
        EXTEfx.alEffecti(this.id, EXTEfx.AL_FILTER_TYPE, EXTEfx.AL_EFFECT_REVERB);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_DENSITY, this.density);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_DIFFUSION, this.diffusion);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_GAIN, this.gain);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_GAINHF, this.gainHF);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_DECAY_TIME, this.decayTime);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_DECAY_HFRATIO, this.decayHFRatio);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_REFLECTIONS_GAIN, this.reflectionsGain);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_REFLECTIONS_DELAY, this.reflectionsDelay);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_LATE_REVERB_GAIN, this.lateReverbGain);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_LATE_REVERB_DELAY, this.lateReverbDelay);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_AIR_ABSORPTION_GAINHF, this.airAbsorptionGainHF);
        EXTEfx.alEffectf(this.id, EXTEfx.AL_REVERB_ROOM_ROLLOFF_FACTOR, this.roomRolloffFactor);
        EXTEfx.alEffecti(this.id, EXTEfx.AL_REVERB_DECAY_HFLIMIT, this.decayHFLimit);
